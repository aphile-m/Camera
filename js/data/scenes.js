...
export const SCENES = [
  ...
  { id:'portrait-shade', group:'People', title:'Portrait in open shade', icon:'◐',
    light:'shade', motion:'gentle', intent:'isolate', focal:50, lens:'prime',
    craft:'The easiest good portrait light there is. Put your subject just inside the shadow line of a building with the open sky in front of them, not behind. Focus on the near eye.',
  ...
  { id:'portrait-backlit', group:'People', title:'Backlit portrait, golden hour', icon:'◑',
    light:'golden', motion:'gentle', intent:'isolate', focal:50, lens:'prime',
  ...
  { id:'portrait-window', group:'People', title:'Window light indoors', icon:'▤',
    light:'indoor_day', motion:'gentle', intent:'isolate', focal:50, lens:'prime',
  ...
  { id:'group', group:'People', title:'Group of people', icon:'▩',
    light:'cloud_bright', motion:'gentle', intent:'sharp_all', focal:35, lens:'kit',
  ...
  { id:'kids-indoor', group:'People', title:'Children indoors', icon:'◔',
    light:'indoor_day', motion:'running', intent:'freeze', focal:35, lens:'prime',
    craft:'Get down to their eye level and stay there. Pre-focus on where they are heading rather than chasing them, and shoot in short bursts.',
  ...
  { id:'landscape-classic', group:'Outdoors', title:'Landscape, front to back', icon:'▰',
    light:'golden', motion:'static', intent:'sharp_all', focal:18, lens:'kit', tripod:true,
  ...
  { id:'waterfall', group:'Outdoors', title:'Silky water', icon:'≋',
    light:'overcast', motion:'gentle', intent:'longexp', focal:35, lens:'kit', tripod:true,
  ...
  { id:'mist', group:'Outdoors', title:'Mist and fog', icon:'░',
    light:'overcast', motion:'static', intent:'natural', focal:55, lens:'kit', tripod:true,
  ...
  { id:'wildlife', group:'Outdoors', title:'Wildlife, golden light', icon:'◕',
    light:'golden', motion:'walking', intent:'freeze', focal:200, lens:'tele',
    ...
    watch:'At 200mm on a crop body you need 1/600 handheld minimum. Raise ISO without hesitating.' },
  { id:'flowers', group:'Outdoors', title:'Flowers and detail', icon:'✿',
    light:'shade', motion:'gentle', intent:'isolate', focal:55, lens:'kit',
  ...
  { id:'street-day', group:'Street & city', title:'Street, daylight', icon:'▥',
    light:'cloud_bright', motion:'walking', intent:'sharp_all', focal:35, lens:'prime',
  ...
  { id:'architecture', group:'Street & city', title:'Architecture', icon:'▦',
    light:'cloud_bright', motion:'static', intent:'sharp_all', focal:18, lens:'kit', tripod:true,
  ...
  { id:'city-blue-hour', group:'Street & city', title:'City at blue hour', icon:'◍',
    light:'blue_hour', motion:'static', intent:'sharp_all', focal:24, lens:'kit', tripod:true,
  ...
  { id:'markets', group:'Street & city', title:'Markets and interiors', icon:'▨',
    light:'indoor_lit', motion:'walking', intent:'lowlight', focal:35, lens:'prime',
  ...
  { id:'sport', group:'Action', title:'Field sport', icon:'⚑',
    light:'cloud_bright', motion:'sport', intent:'freeze', focal:200, lens:'tele',
  ...
  { id:'panning', group:'Action', title:'Panning a moving subject', icon:'⇉',
    light:'cloud_bright', motion:'sport', intent:'blur', focal:55, lens:'kit',
  ...
  { id:'birds', group:'Action', title:'Birds in flight', icon:'✦',
    light:'sun_hazy', motion:'flight', intent:'freeze', focal:200, lens:'tele',
    ...
    watch:'1/2000 minimum for wingtips. ISO 1600 in bright light is a perfectly reasonable price.' },

  /* ---- After dark ------------------------------------------------------ */
  { id:'light-trails', group:'After dark', title:'Traffic light trails', icon:'⌇',
    light:'street_night', motion:'vehicle', intent:'longexp', focal:24, lens:'kit', tripod:true,
  ...
  { id:'stars', group:'After dark', title:'Stars and Milky Way', icon:'✧',
    light:'stars', motion:'static', intent:'lowlight', focal:18, lens:'kit', tripod:true,
  ...
  { id:'night-street', group:'After dark', title:'Street after dark', icon:'◗',
    light:'street_night', motion:'walking', intent:'lowlight', focal:35, lens:'prime',
  ...
  { id:'indoor-event', group:'After dark', title:'Party or indoor event', icon:'◎',
    light:'indoor_dim', motion:'walking', intent:'lowlight', focal:35, lens:'prime',
  ...
  { id:'food', group:'Close & still', title:'Food and flat-lay', icon:'◒',
    light:'indoor_day', motion:'static', intent:'natural', focal:50, lens:'prime',
  ...
  { id:'still-life', group:'Close & still', title:'Still life', icon:'◇',
    light:'indoor_day', motion:'static', intent:'natural', focal:50, lens:'prime', tripod:true,
  ...
  { id:'product', group:'Close & still', title:'Small object, clean background', icon:'□',
    light:'indoor_day', motion:'static', intent:'sharp_all', focal:55, lens:'kit', tripod:true,
